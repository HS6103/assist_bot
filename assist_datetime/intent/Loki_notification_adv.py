...
"""
    Loki module for notification_adv
...
def getResult(inputSTR, utterance, args, resultDICT, refDICT, pattern="", toolkitDICT={}):
    ...
    if utterance == "十點提醒 <@1077237412259971142> 要吃早餐":
        if CHATBOT:
...
if __name__ == "__main__":
    ...
    resultDICT = getResult("提醒 <@1077237412259971142> 要吃早餐", "提醒我 <@1077237412259971142> 要吃早餐", [], {}, {})
    pprint(resultDICT)