...
MODULE_DICT = {
    "Account": import_from_path("assist_record_lib_Account", os.path.join(os.path.dirname(CWD_PATH), "lib/Account.py"))
}
"""
Account 變數清單
[變數] BASE_PATH         => 根目錄位置
...
if __name__ == "__main__":
    ...
    resultDICT = getResult("開會議紀錄", "開[會議紀錄]", [], {}, {})
    pprint(resultDICT)